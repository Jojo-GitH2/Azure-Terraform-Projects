...
resource "azurerm_app_service_source_control" "main" {
  ...
  # repo_url = "https://github.com/Azure-Samples/msdocs-python-django-webapp-quickstart.git"
  # repo_url = "https://github.com/Azure-Samples/msdocs-python-django-webapp-quickstart"
